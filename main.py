...
def import_user_arguments():
    ...
    parser.add_argument("--step_size", type=int, required=True, help="Number of steps to train each generation.")
    parser.add_argument("--eval_steps", type=int, default=0, help="Number of eval steps to train each generation. If 1 or higher, a random subset is sampled from the validation set.")
