...
def import_user_arguments():
    ...
    parser.add_argument("--threading", type=bool, action='store_true', help="Wether to use threads instead of processes.")
    parser.add_argument("--tensorboard", type=bool, action='store_true', help="Wether to enable tensorboard 2.0 for real-time monitoring of the training process.")
    parser.add_argument("--detect_NaN", type=bool, action='store_true', help="Wether to enable NaN detection.")
    parser.add_argument("--old_controller", type=bool, action='store_true', help="Wether to use the old controller.")
    parser.add_argument("--logging", type=bool, action='store_true', help="Wether to enable logging.")
