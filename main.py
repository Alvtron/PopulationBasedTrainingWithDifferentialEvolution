...
def import_arguments():
    ...
    parser.add_argument("--syncronized", type=bool, default=False, help="Decides wether the training will be run synchronously or not. Certain evolvers depend on this function.")    
